...
/// The frame every screen in every GoKlay app sits in.
///
/// One place for the app bar, the back button and the surface colour, so the
/// three apps' screens cannot each drift a little from the design file.
class GoklayScaffold extends StatelessWidget {
  /// Creates a screen frame.
  const GoklayScaffold({
    required this.title,
    required this.body,
